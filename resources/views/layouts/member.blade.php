        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="activity" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('member.activity.index')}}">Danh sách HĐ</a>
                        <a class="collapse-item" href="{{route('member.activity.registered')}}">Đã đăng ký</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="rule" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('member.rule.index')}}">Danh sách</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#request"
                    ...
                    <i class="fa fa-book" aria-hidden="true"></i>
                    <span>Yêu cầu rút sổ đoàn</span>
                </a>
                <div id="request" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('member.request.index')}}">Danh sách yêu cầu</a>
                    </div>
                </div>
            </li>
